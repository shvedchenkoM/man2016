  ...
  WorkModel.prototype.worker = function(inGraph, startVertex) {
      ...
      // if (weight[this.bag.f].price !== Infinity) {
      //   this.bag.currEdge = {}
      //   this.bag.finalPath = weight[this.bag.f].path;
      //   this.saveState(`PATH FOUND ${this.bag.finalPath}`, 14);
      // } else {
      //   this.saveState(`NO PATH FOUND`, 14);
      // }
